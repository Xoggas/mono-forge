...
public class ShaderResult
{
    ...
    public static async Task<ShaderResult> FromFileAsync(string path, Options options, IEffectCompilerOutput output)
    {
        return FromString(await File.ReadAllTextAsync(path), path, options, output);
    }
