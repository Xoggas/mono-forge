...
public struct ErrorCorrectionConfig
{
    ...
    public ErrorCorrectionConfig(ErrorCorrectionMode mode, DistanceCheckMode distanceCheckMode,
        double minDeviationRatio, double minImproveRatio, IntPtr buffer)
    {
        Mode = mode;
