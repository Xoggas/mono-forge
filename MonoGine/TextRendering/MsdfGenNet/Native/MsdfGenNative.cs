...
internal static class MsdfGenNative
{
    ...
    internal static extern void msdfgen_generateSDF(IntPtr output, IntPtr shape, IntPtr projection, double range,
        IntPtr config);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_generatePseudoSDF(IntPtr output, IntPtr shape, IntPtr projection, double range,
        IntPtr config);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_generateMSDF(IntPtr output, IntPtr shape, IntPtr projection, double range,
        IntPtr config);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_generateMTSDF(IntPtr output, IntPtr shape, IntPtr projection, double range,
        IntPtr config);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_Shape_bound(IntPtr shape, ref double l, ref double b, ref double r,
        ref double t);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_Shape_boundMiters(IntPtr shape, ref double l, ref double b, ref double r,
        ref double t, double border, double miterLimit, int polarity);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_Contour_bound(IntPtr contour, ref double l, ref double b, ref double r,
        ref double t);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern void msdfgen_Contour_boundMiters(IntPtr contour, ref double l, ref double b, ref double r,
        ref double t, double border, double miterLimit, int polarity);
    ...
    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern IntPtr msdfgen_EdgeHolder_newQuadratic(Vector2d p0, Vector2d p1, Vector2d p2,
        EdgeColor edgeColor);

    [DllImport(DllName, CallingConvention = CallingConvention.Cdecl)]
    internal static extern IntPtr msdfgen_EdgeHolder_newCubic(Vector2d p0, Vector2d p1, Vector2d p2, Vector2d p3,
        EdgeColor edgeColor);
